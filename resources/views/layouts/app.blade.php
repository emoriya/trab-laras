...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dash') }}">
            ...
            <div class="sidebar-brand-text mx-3">GuiaCarne</div>
        </a>
...
{{--                    <h6 class="collapse-header">Custom Components:</h6>--}}
                    <a class="collapse-item" href="{{ route('usuarios.index') }}">Listar Todos</a>
                    <a class="collapse-item" href="{{ route('usuarios.create') }}">Cadastrar Novo</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    {{--                                        <h6 class="collapse-header">Custom Components:</h6>--}}
                    <a class="collapse-item" href="{{ route('produtos.index') }}">Listar Todos</a>
                    <a class="collapse-item" href="{{ route('produtos.create') }}">Cadastrar Novo</a>
                </div>
            </div>
        </li>
